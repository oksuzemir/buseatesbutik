...
function replace_add_to_cart()
{
    ...
    if ($currentlang == "en-GB") {
        ...
        echo do_shortcode('<a  href="' . $link . '" class="button addtocartbutton">İncele</a>');
    }
    echo '</p>';
}
...
class Custom_Widgets extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        <div class="parallax-section" style="background-image:url('<?php echo esc_url($instance['image_uri']); ?>');">
            <div class="parallax-overlay"></div>
            <div class="parallax-inner">
                <div class="parallax-h1">
                    <?php
...
\*------------------------------------*/
                                                                            ...
                                                                            if (function_exists('register_sidebar')) {
                                                                                // Define Anasayfa Parallax
                                                                                register_sidebar(array(
                                                                                    'name' => __('Anasayfa Parallax', 'html5blank'),
                                                                                    'description' => __('Anasayfa Parallax', 'html5blank'),
                                                                                    'id' => 'anasayfa-parallax',
